...
public class Employee {
    ...
    public static void main(String[] args) {
        ...
        HourlyEmployee h = new HourlyEmployee(sc);
        h.displayDetails();
        System.out.println("Weekly Salary: $" + h.calculateWeekSalary());
        System.out.println("Bonus: $" + h.calculateBonus());

        SalariedEmployee sE = new SalariedEmployee(sc);
        sE.displayDetails();
        System.out.println("Weekly Salary: $" + sE.calculateMonthlySalary());
        System.out.println("Bonus: $" + sE.calculateBonus());

        SalariedEmployee.ExecutiveEmployee executiveEmployee = new SalariedEmployee.ExecutiveEmployee(sc);
        executiveEmployee.displayDetails();
        System.out.println("Weekly Salary: $" + executiveEmployee.calculateMonthlySalary());
